...
<script>
	...
	$(document).ready(function() {
		...
		table = $('#dataTable').DataTable({
	        ...
	        "ajax": {
	        	"url": "<?php echo site_url('order/ajax_list_runner_orders')?>/" + runner_id + "/" + 2,//1 for runner take order page, 2 for current delivery page
	        	"type": "POST"
	        },
	...
	function complete_delivery(id){
		var url = "<?php echo site_url('order/complete-delivery/') ?>";
