	...
	<div class="container mt-3">
		<div class="card">
			<div class="card-body">
				...
				<h3 class="display-5">Runner Information</h3>
...
<script>
    ...
    $.ajax({
    	...
    	success: function(data)
    	{
    		...
    		$('[name="license_no"]').val(data.runner_license_no);
        },
...
function save()
{
	var url = "<?php echo site_url('profile/editRunnerProfile')?>";
...
{
	var url = "<?php echo site_url('profile/editRunnerProfileEmailPass')?>";
