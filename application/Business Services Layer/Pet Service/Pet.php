...
class Pet extends CI_Controller{
	...
	{
		$data['meta_title'] = 'Pet Stores';
		$data['content_heading'] = 'Here are the Pet stores';
		$data['content_subheading'] = 'Purchase confidently from a wide variety of sellers.';
		$data['meta_keywords'] = 'home_meta_keywords';
		$data['main_content'] = 'Manage Pet/pet_stores_view';
		$data['store_type'] = 'pet';
	...
	{
		$data['meta_title'] = 'Pet Stores';
		$data['content_heading'] = 'Here are the Pet products';
		$data['content_subheading'] = 'Purchase from a wide variety of products.';
		$data['meta_keywords'] = 'home_meta_keywords';
		$data['main_content'] = 'Manage Pet/pet_store_products_view.php';
		$data['store_type'] = 'pet';
	...
	public function view_product($prod_id)
	{
		...
		$data['content_heading'] = 'Here are the Pet products';
		$data['meta_keywords'] = 'home_meta_keywords';
		$data['main_content'] = 'Manage Pet/pet_view_product_view.php';
		$data['store_type'] = 'pet';
