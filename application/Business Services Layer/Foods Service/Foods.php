...
class Foods extends CI_Controller{
	...
	{
		$data['meta_title'] = 'Foods Stores';
		$data['content_heading'] = 'Here are the Foods stores';
		$data['content_subheading'] = 'Purchase confidently from a wide variety of sellers.';
		$data['meta_keywords'] = 'home_meta_keywords';
		$data['main_content'] = 'Manage Foods/foods_stores_view';
		$data['store_type'] = 'food';
	...
	{
		$data['meta_title'] = 'Foods Stores';
		$data['content_heading'] = 'Here are the Foods products';
		$data['content_subheading'] = 'Purchase from a wide variety of products.';
		$data['meta_keywords'] = 'home_meta_keywords';
		$data['main_content'] = 'Manage Foods/foods_store_products_view.php';
		$data['store_type'] = 'food';
	...
	{
		$data['meta_title'] = 'Food Stores';
		$data['content_heading'] = 'Here are the food products';
		$data['meta_keywords'] = 'home_meta_keywords';
		$data['main_content'] = 'Manage Foods/foods_view_product_view.php';
		$data['store_type'] = 'food';
