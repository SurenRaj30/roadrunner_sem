...
class Pharma extends CI_Controller{
	...
	public function index() //service provder/customer view ; list of stores
	{
		$data['meta_title'] = 'Pharmacy Stores';
		$data['content_heading'] = 'Here are the verified Pharmacy stores';
		$data['content_subheading'] = 'Purchase confidently from a wide variety of sellers.';
		$data['meta_keywords'] = 'home_meta_keywords';
		$data['main_content'] = 'Manage Pharma/pharma_stores_view';
		$data['store_type'] = 'med';
	...
	public function products($store_id) //menu for service provider/customer ; list of products
	{
		$data['meta_title'] = 'Pharmacy Stores';
		$data['content_heading'] = 'Here are the Pharmacy products';
		$data['content_subheading'] = 'Purchase from a wide variety of products.';
		$data['meta_keywords'] = 'home_meta_keywords';
		$data['main_content'] = 'Manage Pharma/pharma_store_products_view';
		$data['store_type'] = 'med';
	...
	{
		$data['meta_title'] = 'Pharma Stores';
		$data['content_heading'] = 'Here are the pharma products';
		$data['meta_keywords'] = 'home_meta_keywords';
		$data['main_content'] = 'Manage Pharma/pharma_view_product_view.php';
		$data['store_type'] = 'med';
